...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ url('data/profile/images/' . Auth::guard('team')->user()->img) }}" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::guard('team')->user()->name }}</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>{{ Auth::guard('team')->user()->name }}</h6>
              <span>{{ Auth::guard('team')->user()->job_title }}</span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ url('admin/profile/' . Auth::guard('team')->user()->id ) }}">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <form action="{{ url('admin/' . $data) }}" method="post">
          ...
          <input type="submit" style="border: none;
                                      background: none;
                                      color: #012970;
                                      font-weight: 700;" name="button" value="{{ $data }}">
        </form>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ url('admin/profile/' . Auth::guard('team')->user()->id) }}">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
